...
//   CONFIRM_FROM              e.g. "Tend <support@tendpray.com>" (must be a verified Resend sender/domain)
...
const CONFIRM_FROM = Deno.env.get("CONFIRM_FROM") ?? "Tend <support@tendpray.com>";
