    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <Section title="What Tend is">
          <p>Tend gives churches a QR code that opens a simple prayer-request page, plus a private inbox where the church's account owner can read and track requests. During the pilot, billing and automated notifications are not active, and features may change or pause without notice. Tend is provided as is.</p>
        </Section>
